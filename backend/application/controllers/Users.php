    ...
    */
    ...
    public function index_post()
    {
		...
		$rules = [
			...
			'first_name' => ['First Name', 'required|min_length[2]|max_length[100]|regex_match[/^[a-zA-Z ]*$/]'],
			'last_name' => ['Last Name', 'required|min_length[1]|max_length[100]|regex_match[/^[a-zA-Z ]*$/]'],
		...
		Validator::make($rules);
		 if (!Validator::fails()) {
			...
			$value  = withSuccess($this->lang->line('user_created_success'),$result);
			$this->response($value, REST_Controller::HTTP_OK);
		}
    } 
