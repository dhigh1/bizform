    ...
    */
    ...
    public function index_post()
    {
		...
		$rules = [
			...
			'modules_id' => ['Modules','required'],
			'api_url' => ['Api Url','required'],
			'api_method' => ['Api Method','min_length[3]|max_length[20]'],
		...
		if (!Validator::fails()) {
			...
			$data = array(	
				...
				'api_method' =>strtoupper($input['api_method']),
				'ui_url' =>$input['ui_url'],
			...
			$id = $this->Mydb->insert_table_data('module_permissions',$data);
