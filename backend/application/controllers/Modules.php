...
class Modules extends REST_Controller {
    ...
    public function __construct() {
       ...
       $this->load->database();
	   $this->load->model("modulesmodel", "", true);
   ...
   public function get_single_result($id){
		...
		$filter_data[0]['type'] = 'modules.id'; $filter_data[0]['value'] = $id;
		
		$getData = $this->modulesmodel->filter($filter_data);	
    ...
    */
...

    {
        ...
        $input = $this->input->post();
			...
			'table_name' => ['Table name','required|min_length[3]|max_length[200]|is_unique[modules.table_name]'],
			];
		$message = [
