...
function(a) {
    ...
    t.prototype.activateDefaultSidebarTheme = function() {
        ...
        var t = this.$body.data("layoutConfig");
        window.sessionStorage && t && t.hasOwnProperty("showRightSidebarOnStart") && t.showRightSidebarOnStart && (sessionStorage.getItem("_HYPER_VISITED_") || (a.RightBar.toggleRightSideBar(), sessionStorage.setItem("_HYPER_VISITED_", !0))), a.Portlet.init(), a.Components.init(), a(window).on("load", function() {
