...
<div class="row">
   ...
   <div class="col-lg-6">
      <div class="mb-2">
         ...
         <select class="form-select refine_filter" data-type="modules-status" id="modules-status">
            <option data-type="modules-status" value="">--select--</option>
            <option data-type="modules-status" value="14">Active</option>
            <option data-type="modules-status" value="15">Inactive</option>
         </select>
      </div>
   </div>
