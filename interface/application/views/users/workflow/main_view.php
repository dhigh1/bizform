        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:;">Work Order</a></li>
   ...
   <div class="col-12">
      <div class="card">
         <div class="card-body">
            <div class="row mb-2">
               <div class="col-sm-10   ">
                  <button class="btn btn-danger mb-2 addData"><i class="mdi mdi-plus-circle me-1"></i> Create State </button>
               </div>
