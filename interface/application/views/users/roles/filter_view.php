...
<div class="row">
   ...
   <div class="mb-2 col-lg-6">
      ...
      <input type="text" class="form-control refine_filter" data-type="departments-name" id="departments-name">
   </div>
   ...
   <div class="col-lg-6">
      <div class="mb-2">
         ...
         <select class="form-select refine_filter" data-type="roles-status" id="roles-status">
            <option data-type="roles-status" value="">--select--</option>
            <option data-type="roles-status" value="5">Active</option>
            <option data-type="roles-status" value="6">Inactive</option>
         </select>
      </div>
   </div>
