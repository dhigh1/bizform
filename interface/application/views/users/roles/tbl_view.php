      ...
      <tbody>
         ...
         ?>
            <tr>
               ...
               <td>
                  <!-- <button class="btn btn-info table-btn-sm" onclick="window.location.href='<?php echo base_url()."module-permissions/manage-role?id=".$datas['id'] ?>'">Manage</button> -->
                  <button class="btn btn-info table-btn-sm getPermission" data-id="<?php echo $datas['id'] ?>">Manage</button>
               </td>
               <td>
