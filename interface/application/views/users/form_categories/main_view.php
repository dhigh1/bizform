        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Form Categories</li>
                </ol>
            </div>
            <h4 class="page-title"> Form Categories</h4>
        </div>
    </div>
</div>
<!-- end page title -->
   ...
   <div class="col-12">
      <div class="card">
         <div class="card-body">
            <div class="row mb-2">
               <div class="col-sm-10   ">
               <button type="button" class="btn btn-danger btn-sm addCategory"><i class="mdi mdi-create"></i> Create Categories</button>
               <!-- <a href="<?php //echo base_url() ?>formbuilder/publish_view" class="btn btn-warning btn-sm">Publish</a> -->
               <!-- <button class="btn btn-warning btn-sm addCampaign">Add Campaign</button> -->
               </div>
               <div class="col-sm-2">
