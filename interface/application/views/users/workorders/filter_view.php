...
<div class="row">
   ...
   <div class=" col-lg-6 col-12">
      <div class="mb-2">
         <label class="form-label">Workorder ID</label>
         <input type="text" class="form-control refine_filter" data-type="workorders-code" id="workorders-code">
      </div>      
   </div>
   <div class="col-lg-6">
      <div class="mb-2">
         ...
         <select class="form-select refine_filter" data-type="sortby" id="sortby">
            ...
            <option data-type="sortby" value="id">Workorder ID</option>
         </select>
      </div>
   </div>
