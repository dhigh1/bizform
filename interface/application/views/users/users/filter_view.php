...
<div class="row">
   ...
   <div class="mb-2 col-lg-6">
      ...
      <input type="text" class="form-control refine_filter" data-type="login_id" id="login_id">
   </div>

   <div class="mb-2 col-lg-6">
      <label class="form-label">Role name</label>
      <input type="text" class="form-control refine_filter" data-type="roles-name" id="roles-name">
   </div>

   <div class="col-lg-6">
      <div class="mb-2">
         <label class="form-label">Status</label>
         <select class="form-select refine_filter" data-type="users-status" id="users-status">
            <option data-type="users-status" value="">--select--</option>
            <option data-type="users-status" value="7">Active</option>
            <option data-type="users-status" value="8">Inactive</option>
         </select>
      </div>
   </div>
   ...
   <div class="col-lg-6">
      <div class="mb-2">
         ...
         <select class="form-select refine_filter" data-type="sortby" id="sortby">
            ...
            <option data-type="sortby" value="login_id">Login ID</option>
         </select>
      </div>
   </div>
