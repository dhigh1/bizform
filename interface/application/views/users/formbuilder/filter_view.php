...
<div class="row">
   ...
   <div class="col-lg-6">
      <div class="mb-2">
         ...
         <select class="form-select refine_filter" data-type="forms-status" id="forms-status">
            <option data-type="forms-status" value="">--select--</option>
            <option data-type="forms-status" value="77">Active</option>
            <option data-type="forms-status" value="78">Disabled</option>
         </select>
      </div>
   </div>
