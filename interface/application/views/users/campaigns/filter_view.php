...
<div class="row">
   ...
   <div class="col-lg-6">
      <div class="mb-2">
         ...
         <select class="form-select refine_filter" data-type="campaigns-status" id="campaigns-status">
            <option data-type="campaigns-status" value="">--select--</option>
            <option data-type="campaigns-status" value="79">Active</option>
            <option data-type="campaigns-status" value="80">Hold</option>
            <option data-type="campaigns-status" value="81">Stop</option>
         </select>
      </div>
   </div>
